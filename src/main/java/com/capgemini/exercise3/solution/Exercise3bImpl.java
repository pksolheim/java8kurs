...
public class Exercise3bImpl implements com.capgemini.exercise3.Exercise3b {
    ...
    {
        com.capgemini.exercise3.Exercise3b exercise;

        exercise = new com.capgemini.exercise3.solution.Exercise3bImpl();
